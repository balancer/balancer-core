...
module.exports.math = {
    ...
    "calc_OutGivenIn": [
      [(1 - Math.pow((2/(2+1)),(1/1))) * 2
        , [2, 1, 1, 2, 1, 0] ]
    , [(1 - Math.pow((20/(20+10)),(1/1))) * 20
        , [20, 1, 10, 20, 1, 0] ]
    , [(1 - Math.pow((200/(200+1)),(5/3))) * 20
        , [200, 5, 1, 20, 3, 0] ]
    , [(1 - Math.pow((235/(235+32)),(5/2)))*150, 
        [235, 5, 32, 150, 2, 0 ] ]
    , [(1 - Math.pow((2/(2+1*0.98)),(1/1))) * 2, 
        [2, 1, 1, 2, 1, 0.02 ] ]
    , [(1 - Math.pow((20/(20+10*0.99)),(0.1/0.1))) * 20, [20, 1, 10, 20, 1, 0.01 ] ]
    , [(1 - Math.pow((200/(200+1*0.97)),(0.5/0.3))) * 20, [200, 5, 1, 20, 3, 0.03 ] ]
    , [(1 - Math.pow((235/(235+32*0.9)),(0.5/0.2)))*150, [235, 5, 32, 150, 2, 0.1 ] ]


    , [-1, [0, 5, 32, 150, 2, 0.1 ] ]
    , [-1, [235, 0, 32, 150, 2, 0.1 ] ]
    , [-1, [235, 5, 0, 150, 2, 0.1 ] ]
    , [-1, [235, 5, 32, 0, 2, 0.1 ] ]
    , [-1, [235, 5, 32, 150, 0, 0.1 ] ]
    ],
    ...
    "calc_InGivenOut": [
        ...
        [-1, [0, 5, 523, 2, 70,  0.1 ] ],
        [-1, [600, 0, 523, 2, 70,  0.1 ] ],
        [-1, [600, 5, 0, 2, 70,  0.1 ] ],
        [-1, [600, 5, 523, 0, 70,  0.1 ] ],
        [-1, [600, 5, 523, 2, 0,  0.1 ] ],

        // assert when base=2 (#50)
        [-1, [2, 1, 2, 1, 1, 0 ] ],
        [-1, [20, 1, 20, 1, 10,  0] ],
        [-1, [2, 1, 2, 1, 1,  0.02 ] ],
        [-1, [20, 1, 20, 1, 10,  0.01 ] ],
    ...
    "calc_InGivenPrice": [
        ...
        // #50
        [ -1, [ 10, 2, 4600, 4, 114, 0.1 ] ],

        [ -1, [ 0, 2, 4600, 4, 200, 0.1 ] ],
        [ -1, [ 10, 0, 4600, 4, 200, 0.1 ] ],
        [ -1, [ 10, 2, 0, 4, 200, 0.1 ] ],
        [ -1, [ 10, 2, 4600, 0, 200, 0.1 ] ],
        [ -1, [ 10, 2, 4600, 4, 0, 0.1 ] ],
    ],
...
module.exports.StopOutGivenInPoints = [
    {res: (1 - Math.pow((235/(235+32)),(0.5/0.2)))*150, Bi: 235, Wi: 5, Bo: 150, Wo: 2, Ai: 32, fee: 0, 
        Lo: 0},
    {res: (1 - Math.pow((235/(235+32)),(0.5/0.2)))*150, Bi: 235, Wi: 5, Bo: 150, Wo: 2, Ai: 32, fee: 0, 
...
module.exports.ExactInLimitPricePoints = [
    {res: (1 - Math.pow((235/(235+Ai_fromPrice)),(0.5/0.2)))*150, Bi: 235, Wi: 5, Bo: 150, Wo: 2, Ai: Ai_fromPrice, fee: 0, 
        Lp: (150/0.2)/(235/0.5) * priceRatio},
    //lower Ai
    {res: (1 - Math.pow((235/(235+(Ai_fromPrice - 0.001))),(0.5/0.2)))*150, Bi: 235, Wi: 5, Bo: 150, Wo: 2, Ai: Ai_fromPrice - 0.001, fee: 0, 
        Lp: (150/0.2)/(235/0.5) * priceRatio},
    //lower Lp
    {res: (1 - Math.pow((235/(235+(Ai_fromPrice - 0.001))),(0.5/0.2)))*150, Bi: 235, Wi: 5, Bo: 150, Wo: 2, Ai: Ai_fromPrice - 0.001, fee: 0, 
...
module.exports.LimitPriceInExactOutPoints = [
    {res: Ai_fromPrice, Bi: 600, Wi: 5, Bo: 523, Wo: 2, Ao: Ao_fromPrice, fee: 0,
        Lp: (523/0.2)/(600/0.5) * priceRatio},
    //continuity
    {res: (Math.pow(523/(523-(Ao_fromPrice)),0.2/0.5) - 1) * 600, Bi: 600, Wi: 5, Bo: 523, Wo: 2, Ao: (Ao_fromPrice), fee: 0,
        Lp: (523/0.2)/(600/0.5) * priceRatio},
    //lower Lp
    {res: (Math.pow(523/(523-(Ao_fromPrice)),0.2/0.5) - 1) * 600, Bi: 600, Wi: 5, Bo: 523, Wo: 2, Ao: (Ao_fromPrice), fee: 0,
        Lp: (523/0.2)/(600/0.5) * priceRatio * 0.95},
    //lower Ao
    {res: (Math.pow(523/(523-(Ao_fromPrice-0.001)),0.2/0.5) - 1) * 600, Bi: 600, Wi: 5, Bo: 523, Wo: 2, Ao: (Ao_fromPrice - 0.001), fee: 0,
        Lp: (523/0.2)/(600/0.5) * priceRatio},
]
*/
