...
module.exports.math = {
    ...
    , [(1 - Math.pow((200/(200+1)),(0.5/0.3))) * 20
        , [200, 0.5, 1, 20, 0.3, 0] ]
    , [(1 - Math.pow((235/(235+32)),(0.5/0.2)))*150, 
        [235, 0.5, 32, 150, 0.2, 0 ] ]
    , [(1 - Math.pow((2/(2+1*0.98)),(0.1/0.1))) * 2, 
        [2, 0.1, 1, 2, 0.1, 0.02 ] ]
    , [(1 - Math.pow((20/(20+10*0.99)),(0.1/0.1))) * 20, [20, 0.1, 10, 20, 0.1, 0.01 ] ]
    , [(1 - Math.pow((200/(200+1*0.97)),(0.5/0.3))) * 20, [200, 0.5, 1, 20, 0.3, 0.03 ] ]
    , [(1 - Math.pow((235/(235+32*0.9)),(0.5/0.2)))*150, [235, 0.5, 32, 150, 0.2, 0.1 ] ]


    , [-1, [0, 0.5, 32, 150, 0.2, 0.1 ] ]
    , [-1, [235, 0, 32, 150, 0.2, 0.1 ] ]
    , [-1, [235, 0.5, 0, 150, 0.2, 0.1 ] ]
    , [-1, [235, 0.5, 32, 0, 0.2, 0.1 ] ]
    , [-1, [235, 0.5, 32, 150, 0, 0.1 ] ]
    ],
    ...
    "calc_InGivenOut": [
        ...
        [-1, [0, 0.5, 523, 0.2, 70,  0.1 ] ],
        [-1, [600, 0, 523, 0.2, 70,  0.1 ] ],
        [-1, [600, 0.5, 0, 0.2, 70,  0.1 ] ],
        [-1, [600, 0.5, 523, 0, 70,  0.1 ] ],
        [-1, [600, 0.5, 523, 0.2, 0,  0.1 ] ],

        // assert when base=2 (#50)
        [-1, [2, 0.1, 2, 0.1, 1, 0 ] ],
        [-1, [20, 0.1, 20, 0.1, 10,  0] ],
        [-1, [2, 0.1, 2, 0.1, 1,  0.02 ] ],
        [-1, [20, 0.1, 20, 0.1, 10,  0.01 ] ],
    ...
    "calc_InGivenPrice": [
        ...
        [ -1, [ 10, 0, 4600, 0.4, 200, 0.1 ] ],
        [ -1, [ 10, 0.2, 0, 0.4, 200, 0.1 ] ],
        [ -1, [ 10, 0.2, 4600, 0, 200, 0.1 ] ],
        [ -1, [ 10, 0.2, 4600, 0.4, 0, 0.1 ] ],
    ],
