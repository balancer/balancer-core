...
contract('BPool', async () => {
    ...
    describe('With fees', () => {
        ...
        it('swapExactMarginalPrice', async () => {
            ...
            // Checking outputs
            const expected = 0.5;
            const numer = (parseInt(dirtBalance, 10) + Ai) * rockNorm;
            const denom = ((parseInt(rockBalance, 10) - Ao) * dirtNorm * (1 - swapFee));
            const actual = numer / denom;
